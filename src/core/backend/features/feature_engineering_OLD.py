...
# Dataset to load. Switch between small/large datasets by editing this variable.
...
class WalletFeatureEngineer:
    ...
    def engineer_features(self, df: pd.DataFrame, G: nx.DiGraph = None) -> pd.DataFrame:
        ...
        centrality_elapsed = time.perf_counter() - centrality_start
        print(f"Betweenness centrality completed in {centrality_elapsed:.2f} seconds.")
